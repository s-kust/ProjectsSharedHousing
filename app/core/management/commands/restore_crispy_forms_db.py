...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        _ = FullNameColumn.objects.create(name='full_name_1_ivan_ivanoff', schema=schema1, order=3, first_name="Ivan", last_name="Ivanoff")
        ...
        _ = FullNameColumn.objects.create(name='full_name_2_john_smith', schema=schema2, order=3, first_name="John", last_name="Smith")
